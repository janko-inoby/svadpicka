...
<head>
  ...
  <title>Svad(p)ička — Paťka a Janko</title>
...
<main>
  ...
  <section class="rsvp-intro section-pad text-center">
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-8 offset-lg-2">
          <img class="section-illustration rsvp-illustration" src="/assets/images/rsvp.svg" alt="">
          <p class="section-kicker">NAJDÔLEŽITEJŠIA OTÁZKA</p>
          <h2>Prídeš?</h2>
          <p class="narrow-copy">Potvrď nám účasť do <strong>24. 8. 2026</strong>. Každý hosť vypĺňa formulár <strong>samostatne</strong> — áno, aj ten, čo vždy odpovedá za všetkých.</p>
  ...
  <section id="rsvp" class="rsvp-form-section section-pad">
    <img class="botanical botanical-rsvp" src="/assets/images/botanical.svg" alt="">
        ...
        <div class="col-12 col-lg-8 offset-lg-2">
          ...
          <?php if (!$guest): ?>
            <div class="form-card access-note">
              <strong>Toto je osobná pozvánka.</strong>
              <p class="mb-0">Formulár otvoríš cez svoj osobný odkaz, ktorý od nás dostaneš.</p>
            </div>
          <?php else: ?>
            <form id="rsvp-form" action="/api/rsvp" method="post" novalidate>
              ...
              <div class="form-card">
                <label class="field-title" for="name">Meno a priezvisko *</label>
                <input class="form-control" id="name" name="meno_a_priezvisko" value="<?= $esc($fullName) ?>" placeholder="Napíš celé meno" required>
              </div>
              ...
              <fieldset class="form-card">
                ...
                <label class="choice"><input type="radio" name="ucast" value="pridem" required> <span>Prídem, jasné, že prídem</span></label>
                <label class="choice"><input type="radio" name="ucast" value="nepridem"> <span>Neprídem, budem to do smrti ľutovať</span></label>
              </fieldset>
              ...
              <div data-attending>
                <fieldset class="form-card">
                  ...
                  <div class="choice-row">
                    <label class="choice"><input type="radio" name="strava" value="masozravec"> <span>Mäsožravec</span></label>
                    <label class="choice"><input type="radio" name="strava" value="bylinozravec"> <span>Bylinožravec</span></label>
                    <label class="choice"><input type="radio" name="strava" value="vsezravec"> <span>Všežravec</span></label>
                  </div>
                </fieldset>
                ...
                <fieldset class="form-card">
                  ...
                  <div class="choice-row">
                    <label class="choice"><input type="checkbox" name="alergia_lepok"> <span>Lepok</span></label>
                    <label class="choice"><input type="checkbox" name="alergia_laktoza"> <span>Laktóza</span></label>
                  </div>
                  <textarea class="form-control" name="alergie_ine" placeholder="+ Iné — napíš nám, z čoho Ti bude nevoľno"></textarea>
                </fieldset>
                ...
                <fieldset class="form-card">
                  ...
                  <div class="choice-row choice-row-wrap">
                    <?php foreach (['pivo'=>'Pivo','biele_vino'=>'Biele víno','cervene_vino'=>'Červené víno','prosecco'=>'Prosecco','rum'=>'Rum','whiskey'=>'Whiskey','gin'=>'Gin','tequila'=>'Tequila','vodka'=>'Vodka','nepijem'=>'Nepijem alkohol'] as $value => $label): ?>
                      <label class="choice"><input type="checkbox" name="alkohol[]" value="<?= $value ?>"> <span><?= $label ?></span></label>
                    <?php endforeach; ?>
                  </div>
                  <textarea class="form-control" name="nealko" placeholder="A čo Ti máme pripraviť bez alkoholu?"></textarea>
                </fieldset>

                <fieldset class="form-card">
                  <legend class="field-title">Potrebuješ nocľah? *</legend>
                  <div class="choice-row">
                    <label class="choice"><input type="radio" name="ubytovanie" value="ano"> <span>Áno</span></label>
                    <label class="choice"><input type="radio" name="ubytovanie" value="nie"> <span>Nie</span></label>
                  </div>
                  <p class="field-note">60 € / osoba / noc · priamo v areáli</p>
                </fieldset>

                <fieldset class="form-card">
                  <legend class="field-title">Koleso neŠťastia *</legend>
                  <label class="choice"><input type="checkbox" name="koleso_suhlas" value="true"> <span>Súhlasím, že môžem byť dobrovoľne/nedobrovoľne zapojený/á.</span></label>
                </fieldset>

                <div class="form-card">
                  <label class="field-title" for="dzubox">DŽUBOX</label>
                  <p class="field-note">Sem napíš piesenku, ktorú pridáme do Spotifája a zahráme Ti ju (možno).</p>
                  <textarea class="form-control" id="dzubox" name="dzubox" placeholder="Interpret — názov pesničky"></textarea>
                </div>

                <div class="form-card">
                  <label class="field-title" for="note">Odkaz pre nás</label>
                  <textarea class="form-control" id="note" name="poznamka" placeholder="Niečo, čo sme sa nespýtali?"></textarea>
                </div>
              </div>
  ...
  <section class="program-section section-pad">
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-8 offset-lg-2">
          <div class="layered-icon program-icon" aria-hidden="true">
            <img src="/assets/images/program-1.svg" alt=""><img src="/assets/images/program-2.svg" alt="">
            <img src="/assets/images/program-3.svg" alt=""><img src="/assets/images/program-4.svg" alt="">
          </div>
          <p class="section-kicker">NÁVOD NA POUŽITIE SVÄDBØ FROM IKEA</p>
          <h2>Program</h2>
          <p>in progress ...</p>
          <div class="row g-4 info-grid">
            <div class="col-12 col-lg-6"><article class="info-card"><h3>3:15 parkuješ</h3><p>Odporúčaný príchod. Nech stihneš Velcome drink a pár smalltalkov.</p></article></div>
  ...
  <section class="practical-section section-pad">
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-8 offset-lg-2">
          <img class="section-illustration info-illustration" src="/assets/images/info.svg" alt="">
          <p class="section-kicker">NECH VIEŠ ČO A AKO</p>
          <h2>ne/Dôležité info</h2>
          <div class="row g-4 info-grid">
            <div class="col-12 col-lg-6"><article class="info-card"><h3>Oblečenie</h3><p>Obleč sa pohodlne a možno aj pekne :)</p></article></div>
            ...
            <div class="col-12 col-lg-6"><article class="info-card"><h3>Kontakty</h3><p>Pred svadbou: Paťka · <a href="tel:+421904439302">0904 439 302</a><br>V deň svadby: Veronika · <a href="tel:+421908458424">0908 458 424</a></p></article></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="gifts-section section-pad">
    <img class="botanical botanical-gifts" src="/assets/images/botanical.svg" alt="">
    <div class="container position-relative">
      <div class="row">
        <div class="col-12 col-lg-8 offset-lg-2">
          ...
          <p>Ak nám chceš pomôcť s pergolou, spálňou alebo iným romantickým stavebným projektom, obálka to zvládne najlepšie.</p>
...
<script src="/assets/js/rsvp.js?v=2" defer></script>
</body>
</html>
